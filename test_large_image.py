...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='new_model_2', help='path to exported model directory')
    ...
    crop_gen = get_crop(input_fnames, crop_size=crop_size, adjust_hist=adjust_image)
