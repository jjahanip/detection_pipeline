...
flags.DEFINE_integer('max_proposal', 1500, 'maximum proposal per image')
...
flags.DEFINE_integer('height', 500, 'Network input height size - crop large image with this height')
flags.DEFINE_integer('width', 500, 'Network input width size - crop large image with this height')
